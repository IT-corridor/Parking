angular.module('app')
    .config(['$stateProvider', '$urlRouterProvider', '$ocLazyLoadProvider', '$authProvider',
        ...
        function($stateProvider, $urlRouterProvider, $ocLazyLoadProvider, $authProvider) {
            ...
            .state('app2.park', {
                    url: '/park',
                    templateUrl: 'app/park/buy_park.html',
                    data: { requiredLogin: true }
                })
                .state('app2.reserve_park', {
                    url: '/reserve_park',
                    templateUrl: 'app/park/reserve_park.html',
                    data: { requiredLogin: true }
                })
                .state('app2.pre_charge', {
                    url: '/pre_charge',
                    templateUrl: 'app/park/pre_charge.html',
                    data: { requiredLogin: true }
                })
                .state('app2.sell', {
                    url: '/sell',
                    templateUrl: 'app/park/sell_park.html',
                    data: { requiredLogin: true },
                    resolve: {
                        deps: ['$ocLazyLoad', function($ocLazyLoad) {
                            return $ocLazyLoad.load([
